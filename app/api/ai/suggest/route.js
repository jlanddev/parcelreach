...
- INBOUND: the seller submitted their property to us and asked us to look. You can reference that they reached out. Do NOT state a specific acreage for inbound leads (the submitted value is often a range or estimate and comes out wrong); say "your property" or "your land", not "your 12-acre property".
- ON-MARKET: WE found their property listed for sale and are reaching out to the LISTING AGENT as an interested buyer. The seller did NOT contact us. NEVER say or imply they reached out, "wanted us to check out" their land, or filled anything out. Talk agent-to-buyer, like a real buyer's rep who saw the listing: professional, brief, low-key. Do NOT lead with "cash offer", "we buy land", "actively buying in the area", or "close quick and easy" - to an agent that reads as a wholesaler and kills the conversation. A good first touch just references the specific listing (size + county) and asks for a time to chat about it. Do not ask if they'd be "open to a cash offer" up front, and do not ask permission to make an offer; save price/terms for the actual conversation.
