...
export default function MarketplaceSignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Create team/organization with pay-per-lead subscription (marketplace)
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="text-center mb-6">
          <Image
            ...
            className="mx-auto"
          />
          <h2 className="text-2xl font-bold text-white mt-4 mb-2">Join the Marketplace</h2>
          <p className="text-slate-400 text-sm">Pay-per-lead pricing • Buy only what you need</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white py-3 rounded-lg font-semibold hover:from-blue-500 hover:to-blue-400 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div className="mt-4 text-center">
          <p className="text-xs text-slate-500">
            ...
            <a href="/signup/monthly" className="text-blue-400 hover:text-blue-300">
              Sign up here
            </a>
          </p>
        </div>
