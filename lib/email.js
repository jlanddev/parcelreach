...
export async function sendPricedLeadAvailableNotification({ toEmail, toName, location, acres, price }) {
  const subject = `New Lead Available for Purchase - $${price}`;
  ...
  const html = `
    ...
    <head>
      ...
      <style>
        ...
        .content { background: #ffffff; padding: 30px; border: 1px solid #e2e8f0; border-top: none; }
        .lead-details { background: #f0fdf4; padding: 20px; margin: 20px 0; border-radius: 6px; border-left: 4px solid #10b981; }
        .detail-row { padding: 8px 0; }
        .detail-label { font-weight: 600; color: #64748b; display: block; font-size: 12px; text-transform: uppercase; }
        .detail-value { color: #0f172a; font-size: 16px; }
        .price-box { background: #059669; color: white; padding: 15px; text-align: center; border-radius: 6px; margin: 20px 0; }
        .button { display: inline-block; background: #10b981; color: white; padding: 14px 28px; text-decoration: none; border-radius: 6px; font-weight: 600; margin: 20px 0; font-size: 16px; }
        .footer { text-align: center; padding: 20px; color: #64748b; font-size: 14px; }
      </style>
    </head>
    <body>
      <div class="container">
        <div class="header">
          <h1 style="margin: 0; font-size: 24px;">💎 New Lead Available for Purchase</h1>
        </div>
        <div class="content">
          <p>Hi ${toName || 'there'},</p>
          <p><strong>A new lead is now available for purchase in your marketplace.</strong></p>
          <div class="lead-details">
            <div class="detail-row">
              <span class="detail-label">Location</span>
              <span class="detail-value">${location}</span>
          ...
          <div class="price-box">
            <div style="font-size: 14px; opacity: 0.9; margin-bottom: 5px;">Lead Price</div>
          ...
          <p style="color: #64748b; font-size: 14px;">
            You're receiving this email because a new lead is available for purchase in your ParcelReach marketplace.
          </p>
        </div>
        <div class="footer">
          <p>© 2025 ParcelReach AI. All rights reserved.</p>
  ...
  const html = `
    ...
    <head>
      ...
      <style>
        ...
        .container { max-width: 600px; margin: 0 auto; padding: 20px; }
        .header { background: linear-gradient(135deg, #0f172a 0%, #1e3a8a 100%); color: white; padding: 30px; text-align: center; border-radius: 8px 8px 0 0; }
        .success-badge { background: #10b981; color: white; display: inline-block; padding: 8px 16px; border-radius: 20px; font-size: 14px; font-weight: 600; margin-bottom: 15px; }
        .content { background: #ffffff; padding: 30px; border: 1px solid #e2e8f0; border-top: none; }
        .lead-details { background: #f1f5f9; padding: 20px; margin: 20px 0; border-radius: 6px; }
        .detail-row { padding: 8px 0; border-bottom: 1px solid #e2e8f0; }
        .detail-row:last-child { border-bottom: none; }
        .detail-label { font-weight: 600; color: #64748b; display: inline-block; min-width: 120px; }
        .detail-value { color: #0f172a; }
        .price-paid { background: #059669; color: white; padding: 15px; text-align: center; border-radius: 6px; margin: 20px 0; }
        .button { display: inline-block; background: #3b82f6; color: white; padding: 14px 28px; text-decoration: none; border-radius: 6px; font-weight: 600; margin: 20px 0; font-size: 16px; }
        .footer { text-align: center; padding: 20px; color: #64748b; font-size: 14px; }
      </style>
    </head>
    <body>
      <div class="container">
        <div class="header">
          ...
          <h1 style="margin: 0; font-size: 24px;">Lead Purchase Confirmed</h1>
        </div>
        <div class="content">
          <p>Hi ${toName || 'there'},</p>
          <p><strong>Your lead purchase was successful!</strong> You now have full access to the property owner details below.</p>
          ...
          <div class="lead-details">
            <div class="detail-row">
              ...
              <span class="detail-value"><strong>${leadName}</strong></span>
            </div>
            <div class="detail-row">
          ...
          <p style="color: #64748b; font-size: 14px;">
            Questions about your purchase? Contact us at notifications@parcelreach.ai
          </p>
        </div>
        <div class="footer">
          <p>© 2025 ParcelReach AI. All rights reserved.</p>
