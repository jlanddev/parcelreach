...
// One simple deal temperature in every stage: how hot is this lead?
export const DIRECTIONS = [
  { value: 'hot', label: 'Hot', dot: 'bg-red-500', text: 'text-red-300' },
  { value: 'warm', label: 'Warm', dot: 'bg-amber-500', text: 'text-amber-300' },
  { value: 'cold', label: 'Cold', dot: 'bg-slate-500', text: 'text-slate-300' },
  { value: 'ready', label: 'Ready', dot: 'bg-green-500', text: 'text-green-300' },
];
// Back-compat aliases (temperature is the same regardless of stage now).
export const OFFER_DIRECTIONS = DIRECTIONS;
export const GENERAL_DIRECTIONS = DIRECTIONS;
