// US state FIPS prefixes -> name + 2-letter abbreviation. Used by the OM Search
// location picker (State -> County cascade) and to label counties by state.
...
export const stateByFips = Object.fromEntries(US_STATES.map((s) => [s.fips, s]));
export const abbrByFips = Object.fromEntries(US_STATES.map((s) => [s.fips, s.abbr]));
